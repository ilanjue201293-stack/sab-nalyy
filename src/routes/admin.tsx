    ...
    <div className="mt-6 space-y-4">
      ...
      {editing && (
        <div className="card-elevated p-6 space-y-3">
          ...
          <Field label="Screenshots (URLs, one per line)"><Textarea value={Array.isArray(editing.screenshots) ? editing.screenshots.join("\n") : editing.screenshots} onChange={e => setEditing({ ...editing, screenshots: e.target.value })} /></Field>
